...
//echo "<pre>" . print_r($_SESSION, true) . " </pre>"; IMPRIMIR SESSION _DEBUG_
//echo "<pre>" . print_r($seguimientos, true) . " </pre>"; IMPRIMIR SEGUIMIENTOS _DEBUG_
?>
<html lang="es">
                                                ...
                                                <form id="formActualizarDocumentoBuscador" name="formActualizarDocumentoBuscador" class="form-horizontal text-left">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xs-12 col-sm-12 col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="idCorresponsables" class="col-sm-4 control-label">Co-Responsables:</label>
                                                                <div class="col-sm-6">
                                                                    <select class="form-control" id="idCorresponsables" name="idCorresponsables[]" multiple>
                                                                        <?php
                                                                        foreach ($corresponsables as $corresponsable) {
                                                                            $selected = in_array($corresponsable->getIdUsuario(), array_column($selectedCorresponsables, 'idUsuario')) ? 'selected' : '';
                                                                            echo '<option value="' . htmlspecialchars($corresponsable->getIdUsuario()) . '" ' . $selected . '>';
                                                                            echo htmlspecialchars($corresponsable->getNombre() . " " . $corresponsable->getApellidoP());
                                                                            echo '</option>';
                                                                        }
                                                                        ?>
                                                                    </select>
