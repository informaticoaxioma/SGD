<?php require_once '../../negocio/ingresoDocumento/procesarIngresarSalida.php'; ?>
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="panel panel-default sombraPanel">
            <div class="panel-heading colorAxioma">
                <h2 class="text-center blanco">Ingresar Salida</h2>
            </div>
            <div class="panel-body paddingBottom text-center">
                <form id="formIngresarSalida" class="form-horizontal text-left">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-1">
                                    <button class="btn btn-success btn-sm" data-toggle="modal" data-target="#modalAgregarEntidad" onclick="cargarModalAgregarEntidad(1)"><i class="fa fa-plus-circle"></i>&nbsp;Remitente</button>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-1">
                                    <button id="btnAgregarDestinatario" name="btnAgregarDestinatario" class="btn btn-success btn-sm" data-toggle="modal" data-target="#modalAgregarEntidad" onclick="cargarModalAgregarEntidad(2)"><i class="fa fa-plus-circle"></i>&nbsp;Destinatario</button>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="materia" class="col-sm-4 control-label">Materia:</label>
                                <div class="col-sm-8">
                                    <textarea class="form-control noResize" id="materia" name="materia" placeholder="Ingrese Materia..." rows="3"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="materia" class="col-sm-4 control-label">Antecedente:</label>
                                <div class="col-sm-8">
                                    <textarea class="form-control noResize" id="antecedente" name="antecedente" placeholder="Ingrese antecedente..." rows="3"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="incluye" class="col-sm-4 control-label">Incluye:</label>
                                <div class="col-sm-8">
                                    <textarea class="form-control noResize" id="incluye" name="incluye" placeholder="Ingrese Datos..." rows="2"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="comentarios" class="col-sm-4 control-label">Comentarios:</label>
                                <div class="col-sm-8">
                                    <textarea id="comentarios" name="comentarios" class="form-control noResize" placeholder="Ingrese comentario..." rows="2"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="listadoAdjunto" class="col-sm-4 control-label"></label>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6">
                            ...
                            <div class="form-group">
                                <label for="idEstadoDoc" class="col-sm-4 control-label">Estado:</label>
                                <div class="col-sm-6">
                            ...
                            <div class="row">
                                <div id="tablaDocsRelacionados" class="col-md-12 separador">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-4">
                            <div class="form-group ">
                                ...
                                <div class="col-sm-2">
                                    <input type="submit" id="btnIngresarSalida" name="btnIngresarSalida" class="btn btn-success btn-lg" value="Ingresar Salida">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-body">
                ...
                <form id="formAgregarEntidad" class="form-horizontal text-left" >
                    ...
                    <?php if ($usuarioSession->getIdPerfil() == 1 || $usuarioSession->getIdPerfil() == 3 || $usuarioSession->getIdPerfil() == 9): ?>
                        <div class="form-group">
                            <label for="idCargo" class="col-sm-3 control-label">Agregar Cargo: </label>
                            <div class="col-sm-8">
