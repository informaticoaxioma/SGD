...
if ($_GET) {
    ...
    $totalRegistros = $serviceDocumento->contarDocumentosPorSubContratoFlujoYUsuario($idSubContrato, $usuarioSession->getIdUsuario(), $idFlujo);
    $registrosPorHoja = 10;
...
//paginacion dinamica
    ...
    $documentos = $serviceDocumento->getDocumentosPorSubContratoFlujoYUsuarioPaginados($idSubContrato, $usuarioSession->getIdUsuario(), $idFlujo, $inicio, $registrosPorHoja);
