...
if ($_GET) {
    ...
    $totalRegistros = $serviceDocumento->contarTotalDocumentosPorFlujo($idFlujo);
    $registrosPorHoja = 10;
...
//paginacion dinamica
    ...
    $documentos = $serviceDocumento->getDocumentosPaginadosPorFlujo($idFlujo, $inicio, $registrosPorHoja);
}
