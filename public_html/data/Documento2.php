...
class Documento
{
     ...
     */
    public function contarTotalDocumentosPorFlujo($idFlujo)
    { //CONTADOR PARA EL ADMIN
        try {
            $serviceCnx = new Conexion(); //Clase servicio
            $cnx = $serviceCnx->conectar(); //link de conexion
     ...
     */
    public function contarTotalDocumentos()
    { //CONTADOR PARA EL ADMIN
        try {
            $serviceCnx = new Conexion(); //Clase servicio
            $cnx = $serviceCnx->conectar(); //link de conexion
     ...
     */
    public function ingresarDocumento($doc, $fileContent = null, $fileMimeType = null)
    {
        try {
            ...
            error_log("Exito ingreso documento: " . $exito);
            //liberando recursos
     ...
     */
    public function buscarDocumentosPorFiltro($documento, $detalleDoc, $idContrato, $inicio, $resultados, $idPerfil)
    { //Los filtros utilizados esta presentes en los objetos a excepcion del id del flujo (entrada o salida)
        try {
    ...
    public function resultadoBuscador($documento, $detalleDoc, $idContrato, $idPerfil)
    { //Los filtros utilizados esta presentes en los objetos a excepcion del id del flujo (entrada o salida)
        try {
